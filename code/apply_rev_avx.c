...
{
__m512d  v00,  v01,  v10,  v11,  v20,  v21,  v30,  v31, gamma, sigma, tmp;
v00 =  _mm512_loadu_pd(&V[i]);
v01 =  _mm512_loadu_pd(&V[i + 8]);
v10 =  _mm512_loadu_pd(&V[i + ldv]);
v11 =  _mm512_loadu_pd(&V[i + ldv + 8]);
v20 =  _mm512_loadu_pd(&V[i + 2 * ldv]);
v21 =  _mm512_loadu_pd(&V[i + 2 * ldv + 8]);
 ...
 v11 = _mm512_sub_pd(_mm512_mul_pd(gamma, v11), _mm512_mul_pd(sigma, tmp));
    gamma = _mm512_set1_pd(G[2 *  k  + ldg ]);
    sigma = _mm512_set1_pd(G[2 *  k  + ldg  + 1]);
 tmp = v10;
 ...
 v21 = _mm512_sub_pd(_mm512_mul_pd(gamma, v21), _mm512_mul_pd(sigma, tmp));
    gamma = _mm512_set1_pd(G[2 * (k + 1) ]);
    sigma = _mm512_set1_pd(G[2 * (k + 1)  + 1]);
 tmp = v00;
 v00 =  _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v10));
 v10 = _mm512_sub_pd(_mm512_mul_pd(gamma, v10), _mm512_mul_pd(sigma, tmp));
 tmp = v01;
...
for (int g = 2; g < n - 1; g++)
{
v30= _mm512_loadu_pd(&V[i + (g + 1) * ldv ]);
v31= _mm512_loadu_pd(&V[i + (g + 1) * ldv + 8 ]);
...
tmp = v11;
 v11 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v21));
 v21 = _mm512_sub_pd(_mm512_mul_pd(gamma, v21), _mm512_mul_pd(sigma, tmp));
gamma = _mm512_set1_pd(G[2 * (k + 2) + (g - 2) * ldg]);
sigma = _mm512_set1_pd(G[2 * (k + 2) + (g - 2) * ldg + 1]);
tmp = v00;
 v00 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v10));
 v10 = _mm512_sub_pd(_mm512_mul_pd(gamma, v10), _mm512_mul_pd(sigma, tmp));
tmp = v01;
 v01 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v11));
 v11 = _mm512_sub_pd(_mm512_mul_pd(gamma, v11), _mm512_mul_pd(sigma, tmp));
_mm512_storeu_pd(&V[i + (g-2) * ldv ], v00);
_mm512_storeu_pd(&V[i + (g-2) * ldv + 8], v01);
v00=v10;
v01=v11;
v10=v20;
v11=v21;
...
tmp = v11;
 v11 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v21));
 v21 = _mm512_sub_pd(_mm512_mul_pd(gamma, v21), _mm512_mul_pd(sigma, tmp));
gamma = _mm512_set1_pd(G[2 * (k + 2) + (n - 3) * ldg]);
sigma = _mm512_set1_pd(G[2 * (k + 2) + (n - 3) * ldg + 1]);
tmp = v00;
 v00 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v10));
 v10 = _mm512_sub_pd(_mm512_mul_pd(gamma, v10), _mm512_mul_pd(sigma, tmp));
tmp = v01;
 v01 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v11));
 v11 = _mm512_sub_pd(_mm512_mul_pd(gamma, v11), _mm512_mul_pd(sigma, tmp));
gamma = _mm512_set1_pd(G[2 * (k + 2) + (n - 2) * ldg]);
sigma = _mm512_set1_pd(G[2 * (k + 2) + (n - 2) * ldg + 1]);
tmp = v10;
 v10 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v20));
 v20 = _mm512_sub_pd(_mm512_mul_pd(gamma, v20), _mm512_mul_pd(sigma, tmp));
tmp = v11;
 v11 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v21));
 v21 = _mm512_sub_pd(_mm512_mul_pd(gamma, v21), _mm512_mul_pd(sigma, tmp));
_mm512_storeu_pd(&V[i + (n - 3) * ldv], v00);
_mm512_storeu_pd(&V[i + (n - 3) * ldv + 8], v01);
_mm512_storeu_pd(&V[i + (n - 2) * ldv], v10);
_mm512_storeu_pd(&V[i + (n - 2) * ldv + 8], v11);
_mm512_storeu_pd(&V[i + (n - 1) * ldv], v20);
_mm512_storeu_pd(&V[i + (n - 1) * ldv + 8], v21);
}
