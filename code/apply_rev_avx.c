...
{
__m512d  v00,  v01,  v02,  v03,  v10,  v11,  v12,  v13,  v20,  v21,  v22,  v23, gamma, sigma, tmp;
v00 = _mm512_loadu_pd(&V[0 + 0]);
v01 = _mm512_loadu_pd(&V[0 + 8]);
v02 = _mm512_loadu_pd(&V[0 + 16]);
v03 = _mm512_loadu_pd(&V[0 + 24]);
v10 = _mm512_loadu_pd(&V[32 + 0]);
v11 = _mm512_loadu_pd(&V[32 + 8]);
v12 = _mm512_loadu_pd(&V[32 + 16]);
v13 = _mm512_loadu_pd(&V[32 + 24]);
...
for (int g = 1; g < n - 1; g++)
{
v20 = _mm512_loadu_pd(&V[(g + 1) * 32 + 0]);
v21 = _mm512_loadu_pd(&V[(g + 1) * 32 + 8]);
v22 = _mm512_loadu_pd(&V[(g + 1) * 32 + 16]);
v23 = _mm512_loadu_pd(&V[(g + 1) * 32 + 24]);
...
tmp = v03;
 v03 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v13));
 v13 = _mm512_sub_pd(_mm512_mul_pd(gamma, v13), _mm512_mul_pd(sigma, tmp));
_mm512_storeu_pd(&V[32 * (g - 1)], v00);
_mm512_storeu_pd(&V[32 * (g - 1) + 8 * 1], v01);
_mm512_storeu_pd(&V[32 * (g - 1) + 8 * 2], v02);
_mm512_storeu_pd(&V[32 * (g - 1) + 8 * 3], v03);
v00=v10;
v01=v11;
v02=v12;
v03=v13;
...
tmp = v03;
 v03 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v13));
 v13 = _mm512_sub_pd(_mm512_mul_pd(gamma, v13), _mm512_mul_pd(sigma, tmp));
_mm512_storeu_pd(&V[32 * (n - 2)], v00);
_mm512_storeu_pd(&V[32 * (n - 2)+ 8 * 1], v01);
_mm512_storeu_pd(&V[32 * (n - 2)+ 8 * 2], v02);
_mm512_storeu_pd(&V[32 * (n - 2)+ 8 * 3], v03);
_mm512_storeu_pd(&V[32 * (n - 1)], v10);
_mm512_storeu_pd(&V[32 * (n - 1)+ 8 * 1], v11);
_mm512_storeu_pd(&V[32 * (n - 1)+ 8 * 2], v12);
_mm512_storeu_pd(&V[32 * (n - 1)+ 8 * 3], v13);
}
...
{
v20 = _mm512_loadu_pd(&V[(g + 1) * 32 + 0]);
v21 = _mm512_loadu_pd(&V[(g + 1) * 32 + 4]);
v22 = _mm512_loadu_pd(&V[(g + 1) * 32 + 8]);
v23 = _mm512_loadu_pd(&V[(g + 1) * 32 + 12]);
gamma = _mm512_set1_pd(G[2 * g + k * ldg]);
sigma = _mm512_set1_pd(G[2 * g + k * ldg + 1]);
tmp = v10;
 v10 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v20));
