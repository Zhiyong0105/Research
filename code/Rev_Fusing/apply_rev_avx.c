...
{
__m256d  v00,  v01,  v02,  v03,  v04,  v05,  v10,  v11,  v12,  v13,  v14,  v15,  v20,  v21,  v22,  v23,  v24,  v25,  v30,  v31,  v32,  v33,  v34,  v35, gamma, sigma, tmp;
...
{
__m512d  v00,  v01,  v02,  v03,  v04,  v05,  v10,  v11,  v12,  v13,  v14,  v15,  v20,  v21,  v22,  v23,  v24,  v25,  v30,  v31,  v32,  v33,  v34,  v35, gamma, sigma, tmp;
...
v10 = _mm512_loadu_pd(&V[48 + 0]);
v11 = _mm512_loadu_pd(&V[48 + 8]);
v12 = _mm512_loadu_pd(&V[48 + 16]);
v13 = _mm512_loadu_pd(&V[48 + 24]);
v14 = _mm512_loadu_pd(&V[48 + 32]);
v15 = _mm512_loadu_pd(&V[48 + 40]);
v20 = _mm512_loadu_pd(&V[96 + 0]);
v21 = _mm512_loadu_pd(&V[96 + 8]);
v22 = _mm512_loadu_pd(&V[96 + 16]);
v23 = _mm512_loadu_pd(&V[96 + 24]);
v24 = _mm512_loadu_pd(&V[96 + 32]);
v25 = _mm512_loadu_pd(&V[96 + 40]);
...
for (int g = 2; g < n - 1; g++)
{
v30 = _mm512_loadu_pd(&V[(g + 1) * 48 + 0]);
v31 = _mm512_loadu_pd(&V[(g + 1) * 48 + 8]);
v32 = _mm512_loadu_pd(&V[(g + 1) * 48 + 16]);
v33 = _mm512_loadu_pd(&V[(g + 1) * 48 + 24]);
v34 = _mm512_loadu_pd(&V[(g + 1) * 48 + 32]);
v35 = _mm512_loadu_pd(&V[(g + 1) * 48 + 40]);
...
tmp = v05;
 v05 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v15));
 v15 = _mm512_sub_pd(_mm512_mul_pd(gamma, v15), _mm512_mul_pd(sigma, tmp));
_mm512_storeu_pd(&V[48 * (g - 2)], v00);
_mm512_storeu_pd(&V[48 * (g - 2) + 8 * 1], v01);
_mm512_storeu_pd(&V[48 * (g - 2) + 8 * 2], v02);
_mm512_storeu_pd(&V[48 * (g - 2) + 8 * 3], v03);
_mm512_storeu_pd(&V[48 * (g - 2) + 8 * 4], v04);
_mm512_storeu_pd(&V[48 * (g - 2) + 8 * 5], v05);
v00=v10;
v01=v11;
v02=v12;
v03=v13;
...
tmp = v15;
 v15 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v25));
 v25 = _mm512_sub_pd(_mm512_mul_pd(gamma, v25), _mm512_mul_pd(sigma, tmp));
_mm512_storeu_pd(&V[48 * (n - 3)], v00);
_mm512_storeu_pd(&V[48 * (n - 3)+ 8 * 1], v01);
_mm512_storeu_pd(&V[48 * (n - 3)+ 8 * 2], v02);
_mm512_storeu_pd(&V[48 * (n - 3)+ 8 * 3], v03);
_mm512_storeu_pd(&V[48 * (n - 3)+ 8 * 4], v04);
_mm512_storeu_pd(&V[48 * (n - 3)+ 8 * 5], v05);
_mm512_storeu_pd(&V[48 * (n - 2)], v10);
_mm512_storeu_pd(&V[48 * (n - 2)+ 8 * 1], v11);
_mm512_storeu_pd(&V[48 * (n - 2)+ 8 * 2], v12);
_mm512_storeu_pd(&V[48 * (n - 2)+ 8 * 3], v13);
_mm512_storeu_pd(&V[48 * (n - 2)+ 8 * 4], v14);
_mm512_storeu_pd(&V[48 * (n - 2)+ 8 * 5], v15);
_mm512_storeu_pd(&V[48 * (n - 1)], v20);
_mm512_storeu_pd(&V[48 * (n - 1)+ 8 * 1], v21);
_mm512_storeu_pd(&V[48 * (n - 1)+ 8 * 2], v22);
_mm512_storeu_pd(&V[48 * (n - 1)+ 8 * 3], v23);
_mm512_storeu_pd(&V[48 * (n - 1)+ 8 * 4], v24);
_mm512_storeu_pd(&V[48 * (n - 1)+ 8 * 5], v25);
}
...
{
v30 = _mm512_loadu_pd(&V[(g + 1) * 48 + 0]);
v31 = _mm512_loadu_pd(&V[(g + 1) * 48 + 4]);
v32 = _mm512_loadu_pd(&V[(g + 1) * 48 + 8]);
v33 = _mm512_loadu_pd(&V[(g + 1) * 48 + 12]);
v34 = _mm512_loadu_pd(&V[(g + 1) * 48 + 16]);
v35 = _mm512_loadu_pd(&V[(g + 1) * 48 + 20]);
gamma = _mm512_set1_pd(G[2 * g + k * ldg]);
sigma = _mm512_set1_pd(G[2 * g + k * ldg + 1]);
tmp = v20;
 v20 = _mm512_add_pd(_mm512_mul_pd(gamma, tmp), _mm512_mul_pd(sigma, v30));
