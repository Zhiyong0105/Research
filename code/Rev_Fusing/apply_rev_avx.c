...
v26 = _mm512_loadu_pd(&V[112 + 48]);
 ...
 tmp = v01;
 v01 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v11));
 v11 = _mm512_fmsub_pd(gamma, v11, _mm512_mul_pd(sigma, tmp));
 tmp = v02;
 v02 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v12));
 v12 = _mm512_fmsub_pd(gamma, v12, _mm512_mul_pd(sigma, tmp));
 tmp = v03;
 v03 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v13));
 v13 = _mm512_fmsub_pd(gamma, v13, _mm512_mul_pd(sigma, tmp));
 tmp = v04;
 v04 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v14));
 v14 = _mm512_fmsub_pd(gamma, v14, _mm512_mul_pd(sigma, tmp));
 tmp = v05;
 v05 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v15));
 v15 = _mm512_fmsub_pd(gamma, v15, _mm512_mul_pd(sigma, tmp));
 tmp = v06;
 v06 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v16));
 v16 = _mm512_fmsub_pd(gamma, v16, _mm512_mul_pd(sigma, tmp));
    gamma = _mm512_set1_pd(G[2 * 1  + k * ldg]);
    sigma = _mm512_set1_pd(G[2 * 1  + k * ldg + 1]);
 tmp = v10;
 ...
 tmp = v11;
 v11 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v21));
 v21 = _mm512_fmsub_pd(gamma, v21, _mm512_mul_pd(sigma, tmp));
 tmp = v12;
 v12 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v22));
 v22 = _mm512_fmsub_pd(gamma, v22, _mm512_mul_pd(sigma, tmp));
 tmp = v13;
 v13 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v23));
 v23 = _mm512_fmsub_pd(gamma, v23, _mm512_mul_pd(sigma, tmp));
 tmp = v14;
 v14 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v24));
 v24 = _mm512_fmsub_pd(gamma, v24, _mm512_mul_pd(sigma, tmp));
 tmp = v15;
 v15 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v25));
 v25 = _mm512_fmsub_pd(gamma, v25, _mm512_mul_pd(sigma, tmp));
 tmp = v16;
 v16 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v26));
 v26 = _mm512_fmsub_pd(gamma, v26, _mm512_mul_pd(sigma, tmp));
    gamma = _mm512_set1_pd(G[2 * 0 + (k + 1) * ldg ]);
    sigma = _mm512_set1_pd(G[2 * 0 + (k + 1) * ldg  + 1]);
 tmp = v00;
 v00 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v10));
...
tmp = v21;
 v21 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v31));
 v31 = _mm512_fmsub_pd(gamma, v31, _mm512_mul_pd(sigma, tmp));
tmp = v22;
 v22 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v32));
 v32 = _mm512_fmsub_pd(gamma, v32, _mm512_mul_pd(sigma, tmp));
tmp = v23;
 v23 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v33));
 v33 = _mm512_fmsub_pd(gamma, v33, _mm512_mul_pd(sigma, tmp));
tmp = v24;
 v24 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v34));
 v34 = _mm512_fmsub_pd(gamma, v34, _mm512_mul_pd(sigma, tmp));
tmp = v25;
 v25 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v35));
 v35 = _mm512_fmsub_pd(gamma, v35, _mm512_mul_pd(sigma, tmp));
tmp = v26;
 v26 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v36));
 v36 = _mm512_fmsub_pd(gamma, v36, _mm512_mul_pd(sigma, tmp));
gamma = _mm512_set1_pd(G[2 * (g - 1) + (k + 1) * ldg]);
sigma = _mm512_set1_pd(G[2 * (g - 1) + (k + 1) * ldg + 1]);
tmp = v10;
 v10 = _mm512_fmadd_pd(gamma, tmp, _mm512_mul_pd(sigma, v20));
